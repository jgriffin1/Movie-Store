  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <asp:ListView ID="lvActors" runat="server" ItemPlaceholderID="ItemContainer" OnItemCommand="lvActors_ItemCommand" ClientIDMode="AutoID" ItemType="MovieStore.business.Actor">
          <LayoutTemplate>
            <table class="table">
              <thead>
                <th>First Name</th>
              ...
              <tfoot>
                <tr>
                  <td colspan="4">
                    <asp:LinkButton ID="lbtnAddActor" runat="server" Text="Add Actor" ToolTip="Add Actor"
                      OnClick="lbtnAddActor_Click" />
                  </td>
                </tr>
              </tfoot>
            </table>
            ...
            <tr>
              ...
              <td data-label="Actions">
                <asp:LinkButton ID="lbtnEdit" runat="server" Text="Edit" ToolTip="Edit" CausesValidation="false"
                  CommandName="EditActor" CommandArgument="<%#: Item.Id %>" />
              </td>
            </tr>
          </ItemTemplate>
          <EmptyDataTemplate>
            <p>No Record to display.</p>
            <asp:LinkButton ID="lbtnAddActor" runat="server" Text="Add Actor" ToolTip="Add Actor" OnClick="lbtnAddActor_Click" />
