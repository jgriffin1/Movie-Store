<%@ Page Title="" Async="true" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="MovieStore.Web.Register" %>

<asp:Content ID="cRegister" ContentPlaceHolderID="cphMain" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Register</h1>

                <p>Please fill out all required fields and click register.</p>
                ...
                <div class="form-group">
                    ...
                    <asp:Button ID="btnRegister" runat="server" Text="Register" ToolTip="Register"
                        OnClick="btnRegister_Click" CssClass="btn btn-success btn-sm" />
                </div>
            </div>
        </div>
    </div>
