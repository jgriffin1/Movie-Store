<%@ Page Title="" Async="true" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UpdateMovie.aspx.cs" Inherits="MovieStore.Web.UpdateMovie" %>

<asp:Content ID="cUpdateMovie" ContentPlaceHolderID="cphMain" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Update Movie</h1>
