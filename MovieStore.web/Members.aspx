<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" Async="true" MaintainScrollPositionOnPostback="true" CodeBehind="Members.aspx.cs" Inherits="MovieStore.web.Members" %>
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <asp:Label ID="lblActive" runat="server" AssociatedControlID="rdoActive" Text="Active" />
              <ul class="list-group">
                <li class="list-group-item">
                  <asp:RadioButtonList ID="rdoActive" runat="server">
            ...
            <div class="form-group">
              <asp:Button ID="btnClear" runat="server" Text="Clear" ToolTip="Clear" CausesValidation="false" CssClass="btn btn-dark btn-sm"
            ...
            <asp:ListView ID="lvMembers" OnItemCommand="lvMembers_ItemCommand" runat="server"
              ...
              <ItemTemplate>
                <tr>
                  <td data-label="Name">
                    <asp:Label ID="lblName" runat="server" Text='<%# Item.FirstName + (string.IsNullOrEmpty(Item.MiddleName) ? " " : " " + Item.MiddleName + " ") + Item.LastName %>' />
                  </td>
                  <td data-label="Phone">
