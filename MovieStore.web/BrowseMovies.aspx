<%@ Page Title="" Language="C#" Async="true" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BrowseMovies.aspx.cs" Inherits="MovieStore.Web.BrowseMovies" %>

<asp:Content ID="cBrowseMovies" ContentPlaceHolderID="cphMain" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Movies</h1>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td data-label="Actions">
                                <asp:LinkButton ID="lbtnRent" runat="server" Text="Rent" ToolTip="Rent"
                                    CausesValidation="false" CommandName="RentMovie" CommandArgument='<%#: Item.Id %>' />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <EmptyDataTemplate>
